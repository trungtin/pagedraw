...
if (config.debugExportOption) {
    defaultExport = props => React.createElement(PdVlDropdownTwo, {"valueLink": (props.valueLink), "options": ([
    ...
    defaultExport = props => React.createElement(PdVlDropdownTwo, {"tag": "select", "valueLink": (props.valueLink), "options": ([
        {value: "JSX", label: 'React (JSX)'},
        {value: "CJSX", label: 'CJSX'},
        {value: "TSX", label: 'TSX'},
        {value: "Angular2", label: 'Angular'}])});
