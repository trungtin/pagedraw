...
exports.LibraryPreviewSidebar = LibraryPreviewSidebar = createReactClass
    ...
    render: ->
        ...
        React.createElement("div", {"className": "sidebar", "style": (display: 'flex', flexDirection: 'column', overflowY: 'scroll', backgroundColor: "#FCFCFC")},
            (@props.doc.getComponents()?.map (component) =>
                ...
                React.createElement("div", {"className": ('preview-item'), "key": (component.uniqueKey),  \
