...
defaultExport.JsKeyword = (JsKeyword = ({children}) => <span style={{color: '#bd00bd'}}>
    {children}
</span>);
...
defaultExport.GeneratedCodePrefixField = (GeneratedCodePrefixField = ({valueLink}) => <FormControl
    debounced={true}
    tag="textarea"
    valueLink={valueLink}
...
defaultExport.customCodeField = (customCodeField = (valueLink, placeholder) => <FormControl
    debounced={true}
    tag="textarea"
    valueLink={valueLink}
...
defaultExport.codeSidebarEntryHeader = (block_name, label, hint) => <div
    style={{
        margin: '0 0 3px 0',
        fontSize: '10px',
