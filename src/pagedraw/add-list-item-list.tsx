...
export default Addlistitemlist = createReactClass({
    displayName: 'Addlistitemlist',
    render() {
        return React.createElement("div", {"className": "addlistitemlist-addlistitemlist-8"},
          ...
          React.createElement("div", {"className": "addlistitemlist-0"},
              React.createElement("div", {"className": "addlistitemlist-0-0"},
                  ( this.props.items.map((item, i) => {
                      return React.createElement("div", {"key": (i), "onClick": (item.handler), "className": "addlistitemlist-rectangle-7"},
