          ...
          * {
          ...
          `}} />
                      ...
                      <div className="main-figma-3">
                          <div className="main-0-0-0">
                              <div className="main-instance_of_deleted_component-4">
                                  <Banner username={this.props.current_user.name} logout={this.props.logout} />
                              </div>
                          </div>
                                  ...
                                  <div className="main-0-0-1-0-0">
                                      <div className="main-sidebar-2">
                                                                      ...
                                                                      <div key={i} className="main-project_list-2">
                                                                          <div className="main-0-0-1-0-0-0-0-0-2-0-0-0-0">
                                                                              <div className="main-projectitem_instance-9">
                                                                                  <Projectitem
                                                                                      name={app.name}
                                                                                      selected={app.id === this.props.app.id}
                                                                                      onClick={() => this.props.handleAppChanged(app.id)} />
                                                                              </div>
                                                                          </div>
                                                                      </div>
                                                                  );
                                          ...
                                          <div className="main-0-0-1-0-0-0-1">
                                              <a href="/apps/new" className="main-0-0-1-0-0-0-1-0">
                                                  <div className="main-new_project_button-3">
                                                      <Textbutton text="+ NEW PROJECT" onClick={function() {}} disabled={false} />
                                                  </div>
                                              </a>
                                          </div>
                                              ...
                                              <div className="main-collaborators-4">
                                                                      ...
                                                                      <div key={i} className="main-collab_list-9">
                                                                          <div className="main-0-0-1-0-0-0-2-0-2-0-0-0-0">
                                                                              <a
                                                                                  ...
                                                                                  className="main-0-0-1-0-0-0-2-0-2-0-0-0-0-0">
                                                                                  <div className="main-text_15">
                                                                                      {user.email}
                                                                                  </div>
                                                                              </a>
                                                                              <div
                                                                                  onClick={() => this.props.handleCollaboratorDelete(user.id)}
                                                                                  className="main-text_16">
                                                                                  ╳
                                                                              </div>
                                                                          </div>
                                                                      </div>
                                                  ...
                                                  <div className="main-0-0-1-0-0-0-2-0-3">
                                                      <input
                                                          ...
                                                          value={this.props.collaboratorField}
                                                          onChange={e => this.props.setState({collaboratorField: e.target.value})}
                                                          className="main-text_input_2" />
                                                      <button
                                                          type="submit"
                                                          onClick={this.props.handleCollaboratorSubmit}
                                                          className="main-button_2">
                                                          <span>
                                                              Add
                                                          </span>
                                                      </button>
                                              ...
                                              <div className="main-pagedraw_json-9">
                                                  <div className="main-0-0-1-0-0-0-3-0-0">
                                                      <a
                                                          ...
                                                          className="main-0-0-1-0-0-0-3-0-0-0">
                                                          <div className="main-text_3">
                                                              pagedraw.json
                                                          </div>
                                                      </a>
                                                  </div>
                                          ...
                                          <div className="main-0-0-1-0-0-0-4">
                                              <a
                                                  href="https://documentation.pagedraw.io/install/"
                                                  className="main-0-0-1-0-0-0-4-0">
                                              ...
                                              <div className="main-rectangle_1">
                                                                          ...
                                                                          <div className="main-0-0-1-0-0-1-0-0-2-0-0-0-0">
                                                                              <div className="main-pageitem_instance-8">
                                                                                  <Pageitem
                                                                                      ...
                                                                                      text={page.url}
                                                                                      link={`/pages/${page.id}`}
                                                                                      handleDelete={() => this.props.handlePageDelete(page)} />
                                                                              </div>
                                                                          </div>
                                                                      </div>
                                                                  );
                                                  ...
                                                  <div className="main-0-0-1-0-0-1-0-0-3">
                                                      <input
                                                          ...
                                                          value={this.props.pageField}
                                                          onChange={e => this.props.setState({pageField: e.target.value})}
                                                          className="main-text_input-3" />
                                                      <button
                                                          type="submit"
                                                          onClick={this.props.handlePageSubmit}
                                                          className="main-button_3">
                                                          <span>
                                                              ADD
                                                          </span>
                                                      </button>
            ...
            `}
                                                      ...
                                                      <SketchDropzone app={this.props.app}>
            ...
            `}
                                                      ...
                                                      <FigmaModal
                                                          app={this.props.app}
                                                          show_figma_modal={this.props.figma_modal}
                                                          figma_access_token={this.props.figma_access_token}>
                                                              ...
                                                              <div className="main-0-0-1-0-0-1-0-0-4-2-0-0">
                                                                  <div className="main-0-0-1-0-0-1-0-0-4-2-0-0-0">
                                                                      <div className="main-0-0-1-0-0-1-0-0-4-2-0-0-0-0">
                                                                          <img
                                                                              src="https://ucarecdn.com/8fb8956e-20d0-4114-b516-a2d8c5e4dd7e/"
                                                                              className="main-image_3-8" />
                                                                      </div>
                                                                  </div>
                                                                  <div className="main-0-0-1-0-0-1-0-0-4-2-0-0-1">
                                                                      <div className="main-0-0-1-0-0-1-0-0-4-2-0-0-1-0">
                                                                          <div className="main-text_5-9">
                                                                              Import Figma
                                                                          </div>
                                                                      </div>
            ...
            `}
                          ...
                          <div className="main-0-0-3">
                              <div className="main-unnamed_instance_2">
                                  <Footer />
                                  {" "}
                              </div>
                          </div>
