...
export default Pageitem = createReactClass({
    displayName: 'Pageitem',
    render() {
        return React.createElement("div", {"className": "pd-onhover-parent pageitem"},
...
`})}),  
          ( (this.props.state === "A") ?
              React.createElement("div", {"className": "pageitem-a-5"},
                  React.createElement("div", {"className": "pageitem-0-0-0"},
                      React.createElement("a", {"href": `${this.props.link}`, "target": "_blank", "className": "pageitem-0-0-0-0"},
                          React.createElement("div", {"className": "pageitem-text_1"}, ( this.props.text ))
                      ),
                      React.createElement("div", {"onClick": (this.props.handleDelete), "className": "pageitem-text_9"},
                          ("╳")
                      )
                  )
              ) : undefined
          ...
          React.createElement("div", {"className": "pd-onhover pageitem-b_hover-9"},
              React.createElement("div", {"className": "pageitem-1-0"},
                  React.createElement("a", {"href": `${this.props.link}`, "target": "_blank", "className": "pageitem-1-0-0"},
                      React.createElement("div", {"className": "pageitem-text_8"}, ( this.props.text ))
                  ),
                  React.createElement("div", {"onClick": (this.props.handleDelete), "className": "pageitem-text_7"},
                      ("╳")
                  )
              )
          )
