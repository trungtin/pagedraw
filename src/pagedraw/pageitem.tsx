          ...
          `}} />
                {(this.props.state === "A") ?
                      <div className="pageitem-a-5">
                          <div className="pageitem-0-0-0">
                              <a href={`${this.props.link}`} target="_blank" className="pageitem-0-0-0-0">
                                  <div className="pageitem-text_1">
                                      {this.props.text}
                                  </div>
                              </a>
                              <div onClick={this.props.handleDelete} className="pageitem-text_9">
                                  ╳
                              </div>
                          </div>
                      </div> : undefined}
                <div className="pd-onhover pageitem-b_hover-9">
                    <div className="pageitem-1-0">
                        <a href={`${this.props.link}`} target="_blank" className="pageitem-1-0-0">
                            <div className="pageitem-text_8">
                                {this.props.text}
                            </div>
                        </a>
                        <div onClick={this.props.handleDelete} className="pageitem-text_7">
                            ╳
                        </div>
                    </div>
                </div>
