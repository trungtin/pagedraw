          ...
          * {
          ...
          `}
                                ...
                                <div className="meta-app-new-project-1-0-0-1-1">
                                    <input
                                        ...
                                        value={this.props.projectNameField}
                                        onChange={e => this.props.handleProjectNameChange(e.target.value)}
                                        className="meta-app-new-project-project_name-2" />
                                </div>
                                                ...
                                                <div className="meta-app-new-project-1-0-0-1-3-0-0-1">
                                                    <div className="meta-app-new-project-unnamed_instance-0">
                                                        <Frameworkpickerradiobutton
                                                            img="https://ucarecdn.com/217042e2-98ad-4a15-a63c-357202c0c7c0/"
                                                            name="React"
                                                            desc="The Javascript view library from Facebook"
                                                            selected={this.props.framework === 'JSX'}
                                                            handleClick={() => this.props.handleFrameworkChange('JSX')} />
                                                    </div>
                                                    <div className="meta-app-new-project-unnamed_instance-09">
                                                        <Frameworkpickerradiobutton
                                                            img="https://ucarecdn.com/fdcb4b95-69ab-4a6e-be90-6d668181bc54/"
                                                            name="Angular"
                                                            desc="The Front End Framework from Google"
                                                            selected={this.props.framework === 'Angular2'}
                                                            handleClick={() => this.props.handleFrameworkChange('Angular2')} />
                                                    </div>
                                                </div>
                                            </div> : undefined}
                                </div>
          ...
          `}
                                                            ...
                                                            {(!user.is_me) ?
                                                                    <div className="meta-app-new-project-rectangle_10">
                                                                        <div className="meta-app-new-project-1-0-0-1-5-0-0-0-0-1-0-0">
                                                                            <div
                                                                                onClick={() => this.props.handleCollaboratorDelete(user.email)}
                                                                                className="meta-app-new-project-text_19">
                                                                                ╳
                                                                            </div>
                                                                        </div>
                                                                    </div> : undefined}
                                ...
                                <div className="meta-app-new-project-1-0-0-1-6">
                                    <input
                                        type="text"
                                        placeholder="coworker@yourcompany.com"
                                        value={this.props.newCollaboratorField}
                                        onChange={e => this.props.handleNewCollaboratorChanged(e.target.value)}
                                        className="meta-app-new-project-text_input_4" />
                                    <div className="meta-app-new-project-textbutton-3">
                                        <Textbutton text="ADD" onClick={this.props.handleAddCollaborator} disabled={false} />
                                    </div>
                                </div>
          ...
          `}
                                ...
                                <div className="meta-app-new-project-1-0-0-1-8">
                                    <div className="meta-app-new-project-textbutton-1">
                                        <Textbutton text="CREATE PROJECT" onClick={this.props.handleSubmit} disabled={false} />
                                    </div>
                                </div>
                            </div>
                        </div>
