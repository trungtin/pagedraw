            ...
            {(this.props.state === "default") ?
                    <div className="installation-default-1">
                        <div className="installation-0-0-0">
                            <div onClick={this.props.onClick} className="installation-rectangle_3">
            ...
            {(this.props.state === "upgrade") ?
                    <div className="installation-upgrade-5">
                        <div className="installation-1-0-0">
                            <div onClick={this.props.onClick} className="installation-rectangle_3-0">
                                <div className="installation-1-0-0-0-0">
                                    <div className="installation-_upgrade_-5">
                                        {" Upgrade"}
                                    </div>
                                </div>
                            </div>
            ...
            {(this.props.state === "installed") ?
                    <div className="installation-installed-5">
                        <div className="installation-2-0-0">
                            <div onClick={this.props.onClick} className="installation-rectangle_3-05">
