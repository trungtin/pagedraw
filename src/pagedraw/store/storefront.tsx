...
const render = function() {
    return React.createElement("div", {"className": "storefront-storefront-5"},
                            ...
                            ( (this.props.popularLibraries.length > 0) ?
                                React.createElement("div", {"className": "storefront-3-0-0-0-0-0-0"},
                                    ( (this.props.popularLibraries).map((lib, i) => {
                                        return React.createElement("div", {"key": (i), "className": "storefront-repeat_popular_libraries-0"},
                        ...
                        ( (this.props.teamLibraries.length > 0) ?
                            React.createElement("div", {"className": "storefront-5-0-0-0-0-0"},
                                ( (this.props.teamLibraries).map((lib, i) => {
                                    return React.createElement("div", {"key": (i), "className": "storefront-repeat_team_libraries-3"},
                        ...
                        React.createElement("div", {"className": "storefront-optional_build_your_own-7"},
                            React.createElement("div", {"className": "storefront-5-0-0-0-2-0"},
                                React.createElement("div", {"className": "storefront-createlibrarycard_instance-5"},
                                    React.createElement(Createlibrarycard, {"onClick": ((this.props.onCreateNewLibrary))}) 
                                )
                            )
                        ),
