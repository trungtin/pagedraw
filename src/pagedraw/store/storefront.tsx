...
import Createlibrarycard from './createlibrarycard';
        ...
        * {
        ...
        `}
            ...
            <div className="storefront-1">
                <div
                    className="storefront-pagedraw_libraries_allow_you_to_import_existing_react_libraries_straight_into_pagedraw_just_find_a_widget_or_component_library_you_like_add_the_library_to_your_project_and_you_are_ready_to_go_-1">
                    {`\
                    ...
                    <div className="storefront-3-0-0">
                        <div className="storefront-3-0-0-0">
                            <div className="storefront-3-0-0-0-0">
                                {(this.props.popularLibraries.length > 0) ?
                                        <div className="storefront-3-0-0-0-0-0-0">
                                            {(this.props.popularLibraries).map((lib, i) => {
                                                    return (
                                                            ...
                                                            <div className="storefront-3-0-0-0-0-0-0-0-0-0">
                                                                <div className="storefront-popular_libraries-3">
                                                                    <Publiclibrary
                                                                        ...
                                                                        version={lib.version}
                                                                        owner={lib.owner}
                                                                        installCount={lib.installCount}
                                                                        starCount={lib.starCount}
                                                                        installed={lib.installed}
                                                                        repository={lib.repository}
                                                                        onDetails={lib.onDetails}
                                                                        onInstall={lib.onInstall}
                                                                        starred={lib.starred} />
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        `}
                ...
                <div className="storefront-rectangle_11">
                    <div className="storefront-5-0-0">
                        <div className="storefront-5-0-0-0">
                            {(this.props.teamLibraries.length > 0) ?
                                    <div className="storefront-5-0-0-0-0-0">
                                        {(this.props.teamLibraries).map((lib, i) => {
                                                return (
                            ...
                            <div className="storefront-optional_build_your_own-7">
                                <div className="storefront-5-0-0-0-2-0">
                                    <div className="storefront-createlibrarycard_instance-5">
                                        <Createlibrarycard onClick={this.props.onCreateNewLibrary} />
                                    </div>
                                </div>
                            </div>
            ...
            <div className="storefront-7">
                <div
                    className="storefront-_you_can_design_and_develop_components_either_in_code_or_inside_pagedraw_take_a_look_at_developer_documentation_for_more_details_-8">
                    <div>
                        {" You can design and develop components either in code or inside Pagedraw."}
                    </div>
                    <br />
                    <div>
                        Take a look at developer documentation for more details.
                    </div>
                </div>
            </div>
