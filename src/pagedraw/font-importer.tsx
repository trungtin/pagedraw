...
const render = function() {
    return (
        ...
        * {
        ...
        `}} />
            {((!_l.isEmpty(this.props.error) ? 'Error' : this.props.importing ? 'Importing' : 'Initial') === "Initial") ?
            ...
            `}
                                ...
                                <div className="fontimporter-0-0-0-0-2">
                                    <div className="fontimporter-text-6">
                                        <div>
                                            Pagedraw uses file names to infer font names on upload.
                                        </div>
                                        <br />
                                        <div>
                                            If trying to upload a missing font like Lato-regular
                                        </div>
                                        <div>
                                            {"make sure your font file is named exactly \"Lato-regular.ttf\" or equivalent. "}
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {((!_l.isEmpty(this.props.error) ? 'Error' : this.props.importing ? 'Importing' : 'Initial') === "Importing") ?
                    <div className="fontimporter-importing-3">
                        <div className="fontimporter-1-0-0">
                            <img
                                ...
                                className="fontimporter-image-8" />
                        </div>
                    </div> : undefined}
            {((!_l.isEmpty(this.props.error) ? 'Error' : this.props.importing ? 'Importing' : 'Initial') === "Error") ?
                    <div className="fontimporter-error-4">
                        ...
                        <div className="fontimporter-2-0-1">
                            <div
                                className="fontimporter-please_contact_the_pagedraw_team_at_team_pagedraw_io_-0">
                                {`\
